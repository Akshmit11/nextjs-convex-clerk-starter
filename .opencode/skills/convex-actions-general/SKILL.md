...
This skill includes comprehensive reference documentation in `docs/Convex Actions_SKILL.md` (and related docs) that covers:
...
1. **Read the reference documentation** at `docs/Convex Actions_SKILL.md` for comprehensive patterns
